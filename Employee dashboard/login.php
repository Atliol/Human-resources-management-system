...
if ($_SESSION['userlogin'] > 0) {
	...
	if ($query->rowCount() > 0) {
		...
		if (password_verify($password, $hashpass)) {
			...
			$wrongpassword = '
				...
				<strong>ပြန်စစ်ဆေးပါ!😕</strong> Alert <b class="alert-link"></b>သင်ဧ။် passwordမှာ မှားယွင်းနေပါသည်..
	...
	//if username or email not found in database
		...
		$wrongusername = '
			<div class="alert alert-danger alert-dismissible fade show" role="alert">
				<strong>ပြန်စစ်ဆေးပါ!🙃</strong> Alert <b class="alert-link"></b>သင်ဧ။် usernameမှာ မှားယွင်းနေပါသည်..
				<button type="button" class="close" data-dismiss="alert" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>';
					...
					<div class="account-wrapper">
						...
						<form method="POST" enctype="multipart/form-data">
							...
							<div class="form-group text-center">
								...
								<div style="margin-top:10px; margin-left: 280px;" class="dropdown action-label">
							<a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="../Employee dashboard/login.php" data-toggle="dropdown" aria-expanded="false">
							<i class="fa fa-dot-circle-o text-success"></i>Employee Login </a>
