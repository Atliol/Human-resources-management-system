						...
						<div class="modal-content">
							...
							<div class="modal-body">
								<form method="POST">
									...
									<div class="form-group">
										<label>Select Employee UserName <span class="text-danger">*</span></label>
										<select require name="username" class="select">
											...
											{          
												?>  
											<option value="<?php echo htmlentities($row->UserName); ?>">
											<?php echo htmlentities($row->UserName); ?></option>
											<?php } ?> 
										</select>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input name="ov_hours" required class="form-control" type="time">
									</div>
									<div class="form-group">
