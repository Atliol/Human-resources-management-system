...
<html lang="en">
    <head>
        ...
        <title>Training - HRMS employee</title>
										...
										<tr>
											...
											<td>
												<h2 class="table-avatar">
													<a href="Trainingdatail.php?trainingdatailid=<?php echo htmlentities($row->id); ?>" class="avatar"><img alt="picture" src="../HR dashboard/employees/<?php echo htmlentities($row->Picture);?>"></a>
