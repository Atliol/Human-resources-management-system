						...
						<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget">
								<div class="profile-img">
									<a href="client-profile.php?admindatailid=<?php echo htmlentities($row->id); ?>" class="avatar"><img alt="picture" src="clients/<?php echo htmlentities($row->Picture); ?>"></a>
								</div>
								<div class="dropdown profile-action">
									<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    
                                    <a class="dropdown-item" href="clients.php?deleteid=<?php echo htmlentities($row->id); ?>" onclick="return confirm('Bossအားဖျက်ရန်သေချာပြီလား!')"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
								</div>
								...
								<a href="client-profile.php?admindatailid=<?php echo htmlentities($row->id); ?>" class="btn btn-white btn-sm m-t-10">View Profile</a>
							</div>
						</div>
						<?php $cnt+=1; 
						}
