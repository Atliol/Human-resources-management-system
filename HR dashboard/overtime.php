												...
												<td class="text-right">
													<div class="dropdown dropdown-action">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item" href="#" data-toggle="modal" data-target="#edit_overtime<?php echo htmlentities($row->id); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
															<a class="dropdown-item" href="overtime.php?deleteid=<?php echo htmlentities($row->id); ?>" onclick="return confirm('ဖျက်ရန်သေချာပြီလား!')"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
														</div>
													</div>
												</td>
												<!-- Edit Overtime Modal -->
