			...
			<div class="content container-fluid">
				...
				<div class="card mb-0">
								...
								<div class="profile-view">
									<div class="profile-img-wrap">
										<div class="profile-img">
											...
											<a href="#" class="avatar"><img alt="picture" src="employees/<?php echo htmlentities($result->Picture); ?>"></a>
										...
										<div class="row">
											<div class="col-md-5">
												<div class="profile-info-left">
													...
													<small class="text-muted"><?php echo htmlentities($result->Designation); ?></small>
													<div class="staff-id"><?php echo htmlentities($result->Employee_Id); ?></div>
													<div class="small doj text-muted"><?php echo htmlentities($result->Joining_Date); ?></div>
					...
					<div class="tab-content">
						...
						<!--Send message Modal -->
						<?php include_once("includes/modals/message/message.php"); ?>
						<!-- /Send message Modal -->
