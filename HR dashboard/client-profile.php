		...
		<div class="page-wrapper">
			...
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col-sm-12">
							<h3 class="page-title">Boss Profile</h3>
							<ul class="breadcrumb">
				...
				<?php
				$sql = "SELECT * from clients where Id=:did";
								...
								<div class="profile-view">
									<div class="profile-img-wrap">
										<div class="profile-img">
											...
											<a href="#" class="avatar"><img alt="picture" src="clients/<?php echo htmlentities($result->Picture); ?>"></a>
										...
										<div class="row">
											<div class="col-md-5">
												<div class="profile-info-left">
													...
													<div class="staff-id"><?php echo htmlentities($result->ClientId); ?></div>
