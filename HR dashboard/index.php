							...
							<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
								<div class="profile-widget">
									<div class="profile-img">
										<a href="client-profile.php?admindatailid=<?php echo htmlentities($row->id); ?>" class="avatar"><img src="clients/<?php echo htmlentities($row->Picture); ?>" alt="picture"></a>
									</div>

									<h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php?admindatailid=<?php echo htmlentities($row->id); ?>"><?php echo htmlentities($row->FirstName) . " " . htmlentities($row->LastName); ?></a></h4>
				...
				<div class="row staff-grid-row">
					...
					?>
							<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
								<div class="profile-widget">
									<div class="profile-img">
										<a href="hrdatail.php?hrdatailid=<?php echo htmlentities($row->id); ?>" class="avatar"><img src="../HR dashboard/profiles/<?php echo htmlentities($row->Picture); ?>" alt="picture"></a>
									</div>
				...
				<div class="row staff-grid-row">
					...
					?>
							<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
								<div class="profile-widget">
									<div class="profile-img">
										<a href="employee-dashboard.php?empdatailid=<?php echo htmlentities($row->id); ?>" class="avatar"><img src="../HR dashboard/employees/<?php echo htmlentities($row->Picture); ?>" alt="picture"></a>
									</div>
