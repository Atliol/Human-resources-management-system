...
if (strlen($_SESSION['userlogin']) == 0) {
	...
	$query->execute();
	echo "<script>alert('HRမှပေးထားသောခွင့်ရက်အားဖျက်ပြီးပါပြီ');</script>";
					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-striped custom-table mb-0">
								...
								<?php
								$sql = "SELECT * FROM holidays WHERE Department NOT IN ('Admin','HR')";
								$query = $dbh->prepare($sql);
										...
										<tbody>
											<tr class="holiday-upcoming">
												...
												<td class="text-right">
													...
													<a class="dropdown-item" href="#" data-toggle="modal" data-target="#accept_holiday<?php echo htmlentities($row->id); ?>"><i class="fa fa-dot-circle-o text-success"></i> Accepted/Rejected</a>
											...
											<!-- Edit Holiday Modal -->
											<?php include 'includes/modals/holidays/accept_holiday.php'; ?>
												<!-- /Edit Holiday Modal -->
					...
					<div class="row align-items-center">
						<div class="col">
							...
							<ul class="breadcrumb">
								...
								<li class="breadcrumb-item active">Boss Vacation</li>
							</ul>
					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-striped custom-table mb-0">
								...
								<?php
								$sql = "SELECT * FROM holidays WHERE Department='Admin'";
								$query = $dbh->prepare($sql);
				...
				<div class="page-header">
					<div class="row align-items-center">
						<div class="col">
							...
							<ul class="breadcrumb">
								<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
								<li class="breadcrumb-item active">HR Vacation</li>
							</ul>
						</div>
